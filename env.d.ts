/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: a9911efba81341b5abff0448c9a0d595)
// Runtime types generated with workerd@1.20260917.1 2026-09-17 nodejs_compat
interface __BaseEnv_Env {
	OPENAI_API_KEY: string;
	LedgerLensAgent: DurableObjectNamespace<import("./src/server").LedgerLensAgent>;
	BILLING_INVESTIGATION: Workflow<Parameters<import("./src/server").BillingInvestigationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "LedgerLensAgent";
	}
